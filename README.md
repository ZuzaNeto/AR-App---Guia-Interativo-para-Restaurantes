...
* **🎥 Desenvolvimento do App:** [Assista aqui como o app foi desenvolvido](https://youtu.be/MTEbV2OHmqo?si=V27nOUgaYnDIfFIY) — *Explicação técnica sobre a integração do Unity 6 com AR Foundation.*
...
* `/Assets`: Código-fonte, Dataset com prefabs e materiais dos 8 objetos.
